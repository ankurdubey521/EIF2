...
3. Look into how on chain signature verification is done. Again, solidity has functions to handle this, but certain things had to be considered in order for the signature generated by a off chain `ethers` script is succsessfully verified on chain.
4. Prevent replay of transactions, for this I added a nonce field to the transaction body. 

Checkout out [this](https://github.com/ankurdubey521/EIF2/tree/master/week2/contracts/module6) for more information on the implementation. To get an idea of the functionality, take a look at the [tests](https://github.com/ankurdubey521/EIF2/blob/master/week2/test/module6-tests.ts).
